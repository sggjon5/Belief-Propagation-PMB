"""
This code was directly lifted from https://github.com/ewilthil/gospapy/tree/master/gospapy

No edits have been made directly to these functions.

However, it should be noted that if p != 2, then

gospa_localization, gospa_missed and gospa_false do not make any sense,

ideally, these would only be returned from the function if p=2.
